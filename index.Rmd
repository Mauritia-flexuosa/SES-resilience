...
Utilize o *ciclo adaptativo* para descrever a dinâmica de um sistema complexo a sua escolha (sócio-ecológico, ecológico, filosófico, econômico, político, etc). Descreva cada fase do ciclo adaptativo. Fale sobre o que dá identidade a este sistema. Fale sobre as interações (por exemplo práticas de manejo), agentes de mudanças internos e externos, possíveis formas de reorganização e de adaptação, novidades que podem ser incorporadas (como elementos novos ou tecnologias), possíveis estados alternativos e as incertezas associadas à sua dinâmica.
